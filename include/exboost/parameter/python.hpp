...
#ifndef EXBOOST_PARAMETER_PYTHON_060209_HPP_EXBOOST
# define EXBOOST_PARAMETER_PYTHON_060209_HPP_EXBOOST
...
namespace exboost { using namespace boost; namespace parameter { namespace python
{
  namespace python_ = boost::python;
}}}

namespace exboost { using namespace boost; namespace parameter { namespace python { namespace aux
{
...
}}}} // namespace exboost::parameter::python::aux

namespace exboost { using namespace boost; namespace python
{
...
}}} // namespace exboost::parameter::python

#endif // EXBOOST_PARAMETER_PYTHON_060209_HPP_EXBOOST
