...
#ifndef ARG_LIST_050329_HPP_EXBOOST
#define ARG_LIST_050329_HPP_EXBOOST
...
struct empty_arg_list
{
    ...
    // Constructor taking EXBOOST_PARAMETER_MAX_ARITY empty_arg_list
    // arguments; this makes initialization
    empty_arg_list(
        BOOST_PP_ENUM_PARAMS(
            EXBOOST_PARAMETER_MAX_ARITY, void_ BOOST_PP_INTERCEPT
        ))
    {}
    ...
    typename result_of0<F>::type
    operator[](
        EXBOOST_PARAMETER_lazy_default_fallback<K,F> x) const
    {
        return x.compute_default();
    }
...
struct arg_list : Next
{
    ...
    arg_list( // A0& a0, A1& a1, ...
        BOOST_PP_ENUM_BINARY_PARAMS(EXBOOST_PARAMETER_MAX_ARITY, A, & a)
    )
      : Next( // a1, a2, ...
            BOOST_PP_ENUM_SHIFTED_PARAMS(EXBOOST_PARAMETER_MAX_ARITY, a)
          , void_reference()
        )
      , arg(a0)
    {}
...
{
  template <>
  struct begin_impl<::exboost::parameter::aux::arg_list_tag>
  {
      template <class S>
      struct apply
      {
          typedef ::exboost::parameter::aux::arg_list_iterator<S> type;
      };
  };

  template <>
  struct end_impl<::exboost::parameter::aux::arg_list_tag>
  {
      template <class>
      struct apply
      {
          typedef ::exboost::parameter::aux::arg_list_iterator<::exboost::parameter::aux::empty_arg_list> type;
      };
  };
}} // namespace boost::mpl

#endif // ARG_LIST_050329_HPP_EXBOOST
