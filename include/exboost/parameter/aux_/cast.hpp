...
#ifndef EXBOOST_PARAMETER_CAST_060902_HPP_EXBOOST
# define EXBOOST_PARAMETER_CAST_060902_HPP_EXBOOST
...
#  define EXBOOST_PARAMETER_FUNCTION_CAST(value, predicate) value
...
#  define EXBOOST_PARAMETER_FUNCTION_CAST(value, predicate, args) \
    exboost::parameter::aux::cast<void predicate, args>::remove_const( \
        exboost::parameter::aux::cast<void predicate, args>::execute(value) \
    )
...
#endif // EXBOOST_PARAMETER_CAST_060902_HPP_EXBOOST
